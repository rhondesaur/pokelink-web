Vue.component( "Pokemon-Summary", {
  template: `
    ...
    <div id="header">
        ...
        <div id="level"><h1 id="lvl_id">LV</h1>{{pokemon.level}}</div>   
    </div>
    ...
    <div id="info">
     ...
     <table>
        ...
        <tr id="stat-changes">
            <td></td>
            <td><p id="HP-style">{{pokemon.hp.max}}</p></td>
            <td>+2</td>
            <td>+2</td>
            <td>+2</td>
            <td>+2</td>
    ...
    <div id="moves">
        <div 
            v-for="move in moves"
          class="moves" :style="{'background-color': move.color}">
